...
::: {.absolute top=50 left=20  style="font-size:1.8em; padding: 0.3em 0.3em; background-color: rgba(255, 255, 255, .6);"}
data
...
## Source data I work with {visibility="uncounted"}
...
## A strategy - list of data frames

1. Maintain a csv with metadata.

![](images/nycflights_variables_csv.png){}

## A strategy - list of data frames {visibility="uncounted"}
...
3. Save list as .RDS for a reusable data asset.

## A strategy - downstream data

1. Add metadata for new data frame.
![](images/nycflights_variables_csv_with_delay_2lines.png){}
...
3. Save data frame as .RDS for a reusable data asset.
...
## {background-image="images/universe-1.svg" background-size=100% background-repeat=no-repeat} 
...
## {background-image="images/universe-2.svg" background-size=100% background-repeat=no-repeat  visibility="uncounted"} 

::: footer
Photo by <a href="https://unsplash.com/@jeremythomasphoto?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Jeremy Thomas</a> on <a href="https://unsplash.com/photos/the-stars-and-galaxy-as-seen-from-rocky-mountain-national-park-4dpAqfTbvKA?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Unsplash</a>  
:::

## {background-image="images/universe-3.svg" background-size=100% background-repeat=no-repeat  visibility="uncounted"} 
...
**Can you leverage the metadata in your programming environment?**
