...
## {background-image="images/abigail-lynn-9y8c_YDUrYA-unsplash.jpg" background-size=100% background-repeat=no-repeat} 


::: {.fragment .absolute top=100 left=20  style="font-size:1.0em; padding: 0.3em 0.3em; background-color: rgba(255, 255, 255, .9);"}
...
::: footer
Photo by <a href="https://unsplash.com/@shmabbss?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Abigail Lynn</a> on <a href="https://unsplash.com/photos/greenhouse-interior-9y8c_YDUrYA?utm_content=creditCopyText&utm_medium=referral&utm_source=unsplash">Unsplash</a>
:::
